...
'''
The time complexity of this solution will be O(V + E), since in the worst case we will have to traverse all edges of the graph. 
Our search will take O(V) space in the worst case to store the vertices in a given traversal on the stack.
'''
