...
# And then our function that counts the number of subtress could simply use that function:
...
We can improve the runtime by starting at the leaves of the tree, and keeping track of the unival subtree count and value as we percolate back up
'''
