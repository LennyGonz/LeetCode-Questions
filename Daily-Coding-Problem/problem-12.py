'''
It's always good to start off with some test cases

Let's start with small cases and see if we can find some sort of pattern
...
Does this hold for N=4?
Yes, it does. Since we can only get to the 4th step by getting to the 3rd step and going up by one, or by getting to the 2nd step and going up by two
So f(4) = f(3) + f(2)
